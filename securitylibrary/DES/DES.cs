...
namespace SecurityLibrary.DES
{
    ...
    public class DES : CryptographicTechnique
    {
        ...
        /// <summary>
        /// Generates subkeys using the PC-2 permutation table.
        /// </summary>
        /// <param name="PC_2PermutationTable">The PC-2 permutation table.</param>
        /// <param name="permutedKey">The permuted key.</param>
        /// <param name="leftHalfKeys">List containing the left half of the subkeys.</param>
        /// <param name="rightHalfKeys">List containing the right half of the subkeys.</param>
        /// <returns>The generated subkeys.</returns>
